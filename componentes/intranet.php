                    ...
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                      ...
                      <div class="container">
                        <div class="form-group">
                          ...
                          <input class="form-control form-control-sm" v-model="url_map" type="text" placeholder="titulo">
                          <div class="alert alert-primary" role="alert" v-if="flagError === true">
                            {{ error }}
                          </div>
                          <button type="button" @click="add_mapa" class="btn btn-sm btn-success mt-3" name="button">Grabar</button>
                        </div>
                        <div class="form-group">
